# Lore — Le Grand Tour des Huit Mondes
...
Le tracé originel, construit autour de la Caldeira IX, porte le nom de **Circuit Zero**. Il clôt la tournée et met à l’épreuve vitesse, adhérence, refroidissement et stabilité. Aucune Coupe dédiée ne l’utilise : il est réservé à la huitième manche du Grand Open.

## Saison 03 — La Couronne libre

**Mara Vex**, double championne de Meridian Apex, vise une troisième Couronne consécutive. Une clause commerciale donnerait alors à son consortium le contrôle technique de la Ligue pendant dix cycles et remplacerait la grille ouverte par une architecture propriétaire unique.
...
La piste traverse une chaîne de production encore active. Des fours s’ouvrent à quelques mètres du tracé, des conduites de refroidissement passent sous l’asphalte et les plaques magnétiques servent normalement à déplacer des lingots de plusieurs tonnes. C’est le circuit d’homologation officiel.

### Faille Écarlate — Planète Vermillon

Ancien corridor d’extraction planétaire. Les lignes droites ont été creusées par des convois miniers à chenilles. Les tempêtes déplacent les dunes entre deux manches, ce qui rend chaque tour légèrement différent.

### Arc Polaire — Lune cryo Khepri

Un anneau de maintenance longe des glaciers artificiels. Les variations thermiques créent des plaques de glace instantanées et des vents latéraux. Les pilotes les plus rapides ne sont pas toujours ceux qui restent sur la piste.
...
### Circuit Zero — Caldeira IX

Le tracé originel entoure un réacteur tellurique assez puissant pour alimenter une colonie. Les ponts thermiques enjambent les coulées de plasma et les cycles d’éruption redessinent les zones sûres. Circuit Zero ne s’ouvre que pour la finale du Grand Open.

## Les pilotes officiels

- **Mara Vex — Meridian Apex :** double championne, précise et agressive, rivale principale du Hangar 08.
- **K‑17 Sol — Free Relay :** synthétique de navigation devenu pilote après un procès historique.
- **Rook Calder — Free Relay :** vétéran défensif et spécialiste des châssis lourds.
- **Nyx Amani — Umbra Lab :** ingénieure des champs de phase et des trajectoires non conventionnelles.
- **Tao Mercer — Argon Vector :** pilote méthodique, rarement hors trajectoire.
- **Sable‑9 — Umbra Lab :** identité d’origine inconnue et adaptation tactique permanente.
- **Brakk Orlov — Meridian Apex :** équipier de Vex, partisan des lignes directes et des contacts.
...
Le Hangar 08 est une ancienne navette-paddock et la dernière écurie indépendante de la grille. Une équipe de mécaniciens humanoïdes, robots-outilleurs et drones de diagnostic adapte chaque châssis entre les manches. Les crédits y sont convertis en pièces homologuées ; les peintures identifient les machines dans la poussière, la neige ou les projections thermiques.
...
La Ligue résume son règlement en une phrase :

> Toute architecture peut gagner, mais aucune ne peut gagner de la même manière.
